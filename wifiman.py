...
# кейс 1 установка приложения
        el = driver.find_element_by_android_uiautomator('new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text("I\'m in").instance(0));')
        el.click()

        el = driver.find_element_by_android_uiautomator(
            'new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text("ALLOW").instance(0));')
        el.click()

        # el = driver.find_element_by_android_uiautomator(By.xpath("//*[@text='I'm in']").click())
        # el.click()
